scoreboard objectives add dig-u.pickaxe dummy
scoreboard objectives add dig-u.w_pickaxe minecraft.used:minecraft.wooden_pickaxe
scoreboard objectives add dig-u.s_pickaxe minecraft.used:minecraft.stone_pickaxe
...
scoreboard objectives add dig-u.w_axe minecraft.used:minecraft.wooden_axe
scoreboard objectives add dig-u.s_axe minecraft.used:minecraft.stone_axe
...
scoreboard objectives add dig-u.w_shovel minecraft.used:minecraft.wooden_shovel
scoreboard objectives add dig-u.s_shovel minecraft.used:minecraft.stone_shovel
...
scoreboard objectives add dig-u.w_hoe minecraft.used:minecraft.wooden_hoe
scoreboard objectives add dig-u.s_hoe minecraft.used:minecraft.stone_hoe
